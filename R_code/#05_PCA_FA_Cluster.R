...
all <- CreateTableOne(vars = c("人気度", "ビジネス度","都会生活度","非高齢化度"), strata="result_km",factorVars=c("res"),data = DF)
...
##クラスター分析
# 非類似度（距離）を計算
candy_bars <- read_sav("F:/■■■大学/◎◎滋賀医大/■■講義関連/京都府大/講義資料/2023_R/##第5回/dataset/candy_bars.sav")
...
library(caret)
CC_data <- read.csv("C:/Users/biostat_35/Desktop/Candycluster_data2.csv")
CC_data2 <- read.csv("C:/Users/biostat_35/Desktop/Candycluster_data3.csv")

my_data <- CC_data2[, -(1:2)]

my_model<- train (form=Ward ~ ., data=my_data, method="rpart")
rpart.plot::rpart.plot(my_model$finalModel, extra=1)

my_model

ssss <- read.csv("C:/Users/biostat_35/Desktop/ssss.csv")
